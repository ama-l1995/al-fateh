                ...
                <li class="nav-item dropdown">
                    <div class="dropdown">
                        ...
                        <div class="dropdown-menu" aria-labelledby="dropdownMenuButton">
                            <a class="dropdown-item text-dark" href="{{ route('home', ['locale' => app()->getLocale() == 'en' ? 'ar' : 'en']) }}">
            ...
            <div class="sidebar">
                ...
                <div class="user-panel mt-3 pb-3 mb-3 d-flex">
                    ...
                    <div class="info">
                        <a href="" class="d-block">
                            @php
                            $locale = app()->getLocale();
                            $firstNameProperty = $locale . '_first_name';
                            $user = Auth::guard('admin')->user();
                            @endphp
                ...
                <nav class="mt-2">
                    <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
                        ...
                        @if(Auth::guard('admin')->user()->en_type === 'superAdmin' || Auth::guard('admin')->user()->ar_type === 'مسؤل عام')
                        <li class="nav-item">
                            ...
                            <ul class="nav nav-treeview">
                                <li class="nav-item">
                                    <a href="{{ route('all_admins', app()->getLocale()) }}" class="nav-link">
                                        <i class="far fa-circle nav-icon"></i>
                                        <p>All Admins</p>
                                    </a>
                                </li>
                                <li class="nav-item">
                                    <a href="{{ route('create_admin', app()->getLocale()) }}" class="nav-link">
                                        <i class="far fa-circle nav-icon"></i>
